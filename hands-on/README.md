...
**Day 7** hands-on folder: **`hands-on/day-07/`** — streaming & DLT (**topics 19–20**). See **`README.md`**, **`labs.md`**, **`01-Day7-Structured-Streaming-Delta.ipynb`**, **`02-Day7-DLT-Guide-UI-and-Troubleshooting.ipynb`**, DLT notebooks **`03`–`05`** under `day-07/notebooks/`, or equivalent **`.py`** pipeline modules under **`day-07/pipelines/`**.

...
**Day 7** hands-on folder: **`hands-on/day-07/`** — streaming & Lakeflow ETL (**topics 19–20**). See **`README.md`**, **`labs.md`**, **`01-Day7-Structured-Streaming-Delta.ipynb`**, **`day-07/pipelines/*.py`**, and **`day-07/pipelines/DEPLOY.md`**.
